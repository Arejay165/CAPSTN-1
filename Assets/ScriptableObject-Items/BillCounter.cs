...
public class BillCounter : MonoBehaviour, IPointerDownHandler
{
    ...
    void ChangeUI()
    {
        ...
        TransitionManager.instances.MoveTransition(new Vector2(-523f, 0), 0.5f, TransitionManager.instances.changeTransform, TransitionManager.instances.changeTransform.gameObject, true);
